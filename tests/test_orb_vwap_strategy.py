...
def create_data(latest_close):
    """Create controlled market data for ORB + VWAP testing."""
...
def main():
    ...
    print("=" * 60)
    print("GARUDA ORB + VWAP OUTCOME TEST")
    print("=" * 60)
    ...
    if all_tests_passed:
        print("ORB + VWAP Outcome Tests : SUCCESS")
    else:
        print("ORB + VWAP Outcome Tests : FAILED")
