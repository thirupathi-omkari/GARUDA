...
def main():
    ...
    for symbol in SYMBOLS:
        ...
        for mode in sl_modes:
            ...
            # Any structurally invalid stop is reported explicitly.
            #
            # IMPORTANT:
            #   - Do NOT invent a fallback stop.
            #   - Do NOT change the entry.
            #   - Do NOT silently delete the entry from the frozen
            #     universe.
            #
            # Examples:
            #   VWAP-MIDDLE: VWAP is on the wrong side of entry.
            #   ORB_50: ORB range can be zero, producing zero risk.
            #
            # Such entries are excluded only from that SL mode's
            # performance statistics because the locked hypothesis
            # does not define a valid protective stop for them.
            if invalid_count:
                print(
                    f"  INVALID_RISK     : {invalid_count} "
